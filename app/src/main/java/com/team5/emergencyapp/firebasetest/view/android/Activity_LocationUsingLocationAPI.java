...
import com.team5.emergencyapp.firebasetest.view.android.LocationUtil.MyLocationUsingHelper;
import com.team5.emergencyapp.firebasetest.view.android.LocationUtil.PermissionUtils;
...
public class Activity_LocationUsingLocationAPI extends AppCompatActivity implements ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        permissionUtils=new PermissionUtils(Activity_LocationUsingLocationAPI.this);
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(Activity_LocationUsingLocationAPI.this, REQUEST_CHECK_SETTINGS);

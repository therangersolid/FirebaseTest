...
public class Activity_SimpleCalling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simplecalling);
        ...
        FloatingActionButton button2 = (FloatingActionButton) findViewById(R.id.floatingActionButton);
